...
import { listDep, deleteDep, addDep, updateDep } from './dep'
...
Mock.mock(/\/Dep\/list/, listDep)
Mock.mock(/\/Dep\/del/, deleteDep)
Mock.mock(/\/Dep\/update/, updateDep)
Mock.mock(/\/Dep\/add/, addDep)
